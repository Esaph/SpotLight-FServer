...
class SQLPool
{
	...
	private final static int MAX_CONN = 25;
	private static final String placeholder = "FServer(SQLPOOL): ";
	...
	private void initialize() {
		...
		timerRefreezeConnections.schedule(new UnfreezeConnections(), 5000, 800000); // EVERY 15-MINUTES were the
																					// connections called.
	}
	...
	private void initializeConnectionPool() {
		...
		System.out.println(
				SQLPool.placeholder + "Connection Pool is full, added " + this.connectionPool.size() + " connections.");
	}
